...
<div class="w3-row  charts w3-colored-background">
   <div class="w3-col l12 strands" >
    <div class="w3-col l3"><h3>Tune</h3> <br/>Speed up page load speed. Optimise layout for all devices. Your competitors are only a click away.</div>
    ...
    <div class="w3-col l3"><h3>Analyse</h3> <br/>Base your marketing decisions on real world numbers. Know for sure what is working and what is undermining your success. </div>
    <div class="w3-col l3"><h3>Experiment</h3> <br/>Always be improving. Test new ideas against your current best and grow with the winners.</div>
